...
// Source: ./user_profile_mysql_repository.gen.go
...
func (m *MockUserProfileMysqlRepository) DeleteList(ctx context.Context, tx *gorm.DB, ms UserProfiles) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserProfileMysqlRepositoryMockRecorder) DeleteList(ctx, tx, ms interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteList", reflect.TypeOf((*MockUserProfileMysqlRepository)(nil).DeleteList), ctx, tx, ms)
}
...
func (m *MockUserProfileMysqlRepository) UpdateList(ctx context.Context, tx *gorm.DB, ms UserProfiles) (UserProfiles, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserProfileMysqlRepositoryMockRecorder) UpdateList(ctx, tx, ms interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateList", reflect.TypeOf((*MockUserProfileMysqlRepository)(nil).UpdateList), ctx, tx, ms)
}
