...
type MasterLoginBonusItemMysqlRepository interface {
	Find(ctx context.Context, masterLoginBonusItemId int64) (*MasterLoginBonusItem, error)
	FindOrNil(ctx context.Context, masterLoginBonusItemId int64) (*MasterLoginBonusItem, error)
	...
	UpdateList(ctx context.Context, tx *gorm.DB, ms MasterLoginBonusItems) (MasterLoginBonusItems, error)
	Delete(ctx context.Context, tx *gorm.DB, m *MasterLoginBonusItem) error
	DeleteList(ctx context.Context, tx *gorm.DB, ms MasterLoginBonusItems) error
}
