...
func (m *MockMasterLoginBonusScheduleMysqlRepository) DeleteList(ctx context.Context, tx *gorm.DB, ms MasterLoginBonusSchedules) error {
	m.ctrl.T.Helper()
...
func (mr *MockMasterLoginBonusScheduleMysqlRepositoryMockRecorder) DeleteList(ctx, tx, ms interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteList", reflect.TypeOf((*MockMasterLoginBonusScheduleMysqlRepository)(nil).DeleteList), ctx, tx, ms)
}

// Find mocks base method.
func (m *MockMasterLoginBonusScheduleMysqlRepository) Find(ctx context.Context, masterLoginBonusScheduleId int64) (*MasterLoginBonusSchedule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Find", ctx, masterLoginBonusScheduleId)
	ret0, _ := ret[0].(*MasterLoginBonusSchedule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMasterLoginBonusScheduleMysqlRepositoryMockRecorder) Find(ctx, masterLoginBonusScheduleId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockMasterLoginBonusScheduleMysqlRepository)(nil).Find), ctx, masterLoginBonusScheduleId)
}
...
func (m *MockMasterLoginBonusScheduleMysqlRepository) FindOrNil(ctx context.Context, masterLoginBonusScheduleId int64) (*MasterLoginBonusSchedule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOrNil", ctx, masterLoginBonusScheduleId)
	ret0, _ := ret[0].(*MasterLoginBonusSchedule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMasterLoginBonusScheduleMysqlRepositoryMockRecorder) FindOrNil(ctx, masterLoginBonusScheduleId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindOrNil", reflect.TypeOf((*MockMasterLoginBonusScheduleMysqlRepository)(nil).FindOrNil), ctx, masterLoginBonusScheduleId)
}
...
func (m *MockMasterLoginBonusScheduleMysqlRepository) UpdateList(ctx context.Context, tx *gorm.DB, ms MasterLoginBonusSchedules) (MasterLoginBonusSchedules, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMasterLoginBonusScheduleMysqlRepositoryMockRecorder) UpdateList(ctx, tx, ms interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateList", reflect.TypeOf((*MockMasterLoginBonusScheduleMysqlRepository)(nil).UpdateList), ctx, tx, ms)
}
