...
type MasterLoginBonusScheduleMysqlRepository interface {
	Find(ctx context.Context, masterLoginBonusScheduleId int64) (*MasterLoginBonusSchedule, error)
	FindOrNil(ctx context.Context, masterLoginBonusScheduleId int64) (*MasterLoginBonusSchedule, error)
	...
	UpdateList(ctx context.Context, tx *gorm.DB, ms MasterLoginBonusSchedules) (MasterLoginBonusSchedules, error)
	Delete(ctx context.Context, tx *gorm.DB, m *MasterLoginBonusSchedule) error
	DeleteList(ctx context.Context, tx *gorm.DB, ms MasterLoginBonusSchedules) error
}
