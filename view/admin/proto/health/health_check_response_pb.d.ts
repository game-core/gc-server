...
// @generated from file health/health_check_response.proto (package api.game, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message api.game.HealthCheckResponse
 */
export declare class HealthCheckResponse extends Message<HealthCheckResponse> {
  /**
   * @generated from field: optional api.game.AdminHealth admin_health = 1;
   */
  adminHealth?: AdminHealth;

  /**
   * @generated from field: optional api.game.CommonHealth common_health = 2;
   */
  commonHealth?: CommonHealth;

  /**
   * @generated from field: optional api.game.MasterHealth master_health = 3;
   */
  ...
  static readonly typeName = "api.game.HealthCheckResponse";
