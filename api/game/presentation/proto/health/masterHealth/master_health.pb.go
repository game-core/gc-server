...
var file_health_masterHealth_master_health_proto_goTypes = []interface{}{
...
func file_health_masterHealth_master_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_health_masterHealth_master_health_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
