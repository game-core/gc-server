...
import (
	...
	"github.com/game-core/gc-server/api/admin/presentation/proto/loginBonus"
...
// Receive 受け取り
		func (s *loginBonusHandler) Receive(ctx context.Context, req *loginBonus.LoginBonusReceiveRequest) (*loginBonus.LoginBonusReceiveResponse, error) {if err := tokens.CheckJwtClaims(ctx, req.UserId); err != nil {
